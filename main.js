...
document.getElementById("id").innerHTML = sketch;
timer_counter = 0;
timer_check = "";
drawn_sketch = "";
answer = "";
...
function draw(){
    function check_sketch(){
        ...
        if(drawn_sketch == sketch){
            answer = "set";
            score += 1;
            document.getElementById("score").innerHTML = "Sketch to draw:" + sketch; 
            rando();
            timer_check = "complete"
            if(timer_check == "complete" && answer == "set"){
                timer_check == "";
                answer == "";
                updateCanvas();
            }
...
function updateCanvas(){
   document.getElementById("name").innerHTML = "Sketch to draw:" + sketch;
   draw(); 
}
function setup(){
